...
@section('content')
    <h1 class="text-3xl font-extrabold text-orange-600 mb-6">➕ Add New Explore Campaign</h1>
    ...
    <form action="{{ route('admin.explore.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" name="title" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-orange-400 focus:outline-none" required>
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="5" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-orange-400 focus:outline-none" required></textarea>
        </div>
        ...
        <div>
            ...
            <input type="number" name="goal_amount" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-orange-400 focus:outline-none" required>
        </div>
